...
export default function Detail() {
    ...
    const whatsappMessage =
        'Olá, gostaria de entrar em contato a respeito do caso: ';
            ...
            <div className="container">
                ...
                <div>
                    <div className="incident">
                        ...
                        <div className="incidentValue">
                            {formatMoney(incident.value, 'BRL')}
                        </div>
                    </div>
                        ...
                        <div className="innerContactBox">
                            ...
                            <div className="actions">
                                ...
                                >
                                    ...
                                    &nbsp;
                                    <div className="actionText">WhatsApp</div>
                                </a>
                                <a
                                    href="mailto:bielsil27@gmail.com"
                                    className="action btn"
                                >
                                    <FaEnvelope size={20} color="#fff" />
                                    &nbsp;
                                    <div className="actionText">E-mail</div>
                                </a>
                            </div>
                        </div>
                    </div>
